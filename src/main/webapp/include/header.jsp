	  ...
	  <section class="top-bar-section">
	    ...
	    <ul class="right">
	      ...
	      <li class="has-dropdown no-click">
	      	<a href="#"><sec:authentication property="name" /> &nbsp; <i class="fi-torso"></i></a>
	      	<ul class="dropdown">
...
<div id="registerModal" class="reveal-modal tiny" data-reveal aria-labelledby="modalTitle" aria-hidden="true" role="dialog">
	<form action="<c:url value="/j_spring_security_check" />" method="post">
	  <fieldset>
	    ...
	    <label> Full Name
	    	<input class="name" type="text" placeholder="Audrey Hepburn">
	    </label>
	    <label>Email
	    	<input class="email" type="text" placeholder="audrey.hepburn@ecosystemmap.co">
	    </label>
